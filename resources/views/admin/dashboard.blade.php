...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <x-card>
        ...
        <div class="space-y-3">
            <x-button variant="outline-primary" size="sm" href="{{ route('admin.users.create') }}" class="w-full justify-start">
            ...
            <x-button variant="outline-success" size="sm" href="{{ route('admin.products.create') }}" class="w-full justify-start">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <x-button variant="outline-warning" size="sm" href="{{ route('admin.backup.create') }}" class="w-full justify-start">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <x-button variant="outline-info" size="sm" href="{{ route('admin.settings') }}" class="w-full justify-start">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
